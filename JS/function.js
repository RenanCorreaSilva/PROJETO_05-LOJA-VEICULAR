$(function(){
   ...
   function enableTextSelection(){
    ...
    $("body").css("user-select","auto");
       ...
       var directory = '/DANKICODE/PROJETO_05/'
       ...
       //SISTEMAS DE NAVEGAÇÃO DE DEPOIMENTOS
    ...
    function iniciarDepoimentos(){
        $('.depoimento-single p').fadeOut();
        $('.depoimento-single p').eq(0).fadeIn();
    }
